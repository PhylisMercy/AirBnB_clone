...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 14 12:26:00 2023
@author: Phylis Mercy
"""
import sys
import unittest
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_basic_attribute_set(self):
        ...
        """
        self.BM.first_name = 'Phylis'
        self.BM.last_name = 'Mercy'
        self.assertEqual(self.BM.first_name, 'Phylis')
        self.assertEqual(self.BM.last_name, 'Mercy')
